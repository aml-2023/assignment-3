...
parser.add_argument('--tcnn_layers',type=int,default=4,help= 'number of layers for the Time-Extrapolator Convolution')
...
parser.add_argument('--n_epochs',type=int,default=41,help= 'number of epochs to train')
parser.add_argument('--batch_size',type=int,default=256,help= 'batch size')
parser.add_argument('--batch_size_test',type=int,default=8,help= 'batch size for the test set')
...
parser.add_argument('--milestones',type=list,default=[25,30,37],help= 'the epochs after which the learning rate is adjusted by gamma')
